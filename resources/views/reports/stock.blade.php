...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
    <form action="{{ route('reports.stock') }}" method="GET" class="flex flex-wrap items-end gap-3">
        ...
        <a href="{{ route('reports.stock-export', request()->query()) }}" class="text-white bg-gradient-to-r from-green-600 to-green-600 hover:from-green-700 hover:to-green-700 hover:-translate-y-0.5 hover:shadow-lg transition-all duration-200 font-medium rounded-lg text-sm px-5 py-2.5">
            Export CSV
        </a>
    </form>
</div>
